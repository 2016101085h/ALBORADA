              ...
              <div class="card-body">
                <table class="table table-bordered  table-sm ">
                  ...
                  <tr v-for="(estudiante, index) in arrayEstudiantes" :key="estudiante.id">
                    ...
                    <td class="bg-dark">
                      <textarea v-model="estudiante.comentario" cols="30" rows="1" class="form-control"></textarea>
                    </td>              
                  </tr>                                                   
                </table>
                ...
                <button class="btn btn-warning text-white mt-3" @click="registrarNota()">Guardar Cambios</button>
              </div>
            </div>
            <!-- /.card -->
          </div>
