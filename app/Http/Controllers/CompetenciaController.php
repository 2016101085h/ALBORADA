    ...
    public function index(Request $request)
    {
        ...
        if ($buscar == '') {
            ...
            $competencias = Competencia::join('cursos', 'competencias.curso_id', '=', 'cursos.id')
                ...
                ->orderBy('competencias.id', 'asc')->where('competencias.curso_id', '=', $curso_id)->paginate(10);
        } else {
            $competencias = Competencia::join('cursos', 'competencias.curso_id', '=', 'cursos.id')
                ->select(
                    'competencias.id',
                ...
                ->where('competencias.curso_id', '=', $curso_id)->orderBy('competencias.id', 'desc')->paginate(10);
