         ...
         <div class="modal-body">
           <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="form-group row">
               ...
               <div class="col-md-9">
                 <input type="text" @change="toUpper()" v-model="apellido" class="form-control" placeholder="Ingrese el Apellido">
               </div>
             </div> 
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                  ...
                  <div v-if="tipoAccion==1">
                      ...
                      <img :src="imagen" class="img-fluid" width="100px" height="100px">
                  </div>
