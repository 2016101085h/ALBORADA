            ...
            <div class="col-md-12">
              <div class="card">
                  <div class="card-header ">
                    ...
                    <button type="button" @click="abrirModal('rol','registrar')" class="btn btn-secondary bg-secondary ml-2 border-transparent " >
                  ...
                  <div class="form-group row">
                    <div class="col-md-6">
                      <div class="input-group">
                        ...
                        <button type="submit" @click="listarRol(1,buscar,criterio)" class="btn btn-warning text-white rounded-0"><i class="fa fa-search"></i> Buscar</button>
                      </div>
                    </div>
                  </div>
                  <table class="table table-bordered  table-sm  ">
                    ...
                    <tr v-for="rol in arrayRol" :key="rol.id">
                      <td >
                          ...
                          <template v-else>
                          <button type="button" class="btn btn-primary btn-sm" @click="activarRol(rol.id)">
      ...
      <div class="modal-dialog modal-primary modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="text" v-model="nombre" class="form-control" placeholder="Nombre del Rol(a)">
                </div>
          ...
          <div class="modal-footer">
            ...
            <button v-if="tipoAccion==1" type="button" @click="registrarRol()" class="btn btn-primary"><i class="fas fa-sign-in-alt mr-1"></i> Guardar</button>
            <button v-if="tipoAccion==2" type="button" class="btn btn-primary" @click="actualizarRol()"><i class="fas fa-pen-alt mr-1"></i> Actualizar</button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
          ...
          methods:{
              ...
              desactivarRol(id){
                const swalWithBootstrapButtons = Swal.mixin({
                  ...
                  title: 'Esta de seguro de eliminar este Rol?',
              ...
              validarRol(){
                  ...
                  if (!this.descripcion) this.errorMostrarMsjRol.push("La Descripcion del Rol no puede estar vacío.");
